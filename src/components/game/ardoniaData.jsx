...
export const BUILDING_DEFS = {
  ...
  mine:     { id: 'mine',     name: 'Mine',      emoji: '⛏️',  starting: true, maxLevel: 3, upgradeBase: { gold: 4 }, effect: 'gold', effectPerLevel: { 1: 2, 2: 3, 3: 6 }, description: 'L1: +2 Gold/turn · L2: +3 Gold/turn · L3: +6 Gold/turn', unlocks: {}, image: 'https://media.base44.com/images/public/69b732e420481df67e8a6804/a7b81fc3e_26.png' },
  lumber_mill: { id: 'lumber_mill', name: 'Lumber Mill', emoji: '🪵', starting: true, maxLevel: 3, upgradeBase: { gold: 4 }, effect: 'wood', effectPerLevel: { 1: 1, 2: 1, 3: 2 }, description: 'L1: +1 Wood/turn · L2: exchange 1 wheat for 1 wood free/turn · L3: +2 Wood/turn', unlocks: {}, image: 'https://media.base44.com/images/public/69b732e420481df67e8a6804/cbbd104fa_25.png' },
  farm:     { id: 'farm',    name: 'Farm',     emoji: '🌾',  starting: true, maxLevel: 3, upgradeBase: { gold: 3 }, effect: 'wheat', effectPerLevel: { 1: 1, 2: 3, 3: 5 }, description: 'L1: +1 Wheat/turn · L2: +3 Wheat/turn · L3: +5 Wheat/turn', unlocks: {}, image: 'https://media.base44.com/images/public/69b732e420481df67e8a6804/cbbd104fa_25.png' },
  treasury: { id: 'treasury', name: 'Crimson Vault',  emoji: '🏦',  starting: true, maxLevel: 3, upgradeBase: { gold: 3 }, effect: 'crystals', effectPerLevel: { 1: 1, 2: 2, 3: 3 }, description: 'L1: +1 Crystal/turn · L2: +2 Crystals/turn · L3: +3 Crystals/turn', unlocks: {}, image: 'https://media.base44.com/images/public/69b732e420481df67e8a6804/d38213280_17.png' },
  // Constructible - Onishiman buildings (costs from Onishiman spreadsheet)
  imperial_stronghold: { id: 'imperial_stronghold', name: 'Imperial Stronghold', emoji: '🏯', starting: false, cost: { gold: 3, wood: 2 }, maxLevel: 1, upgradeBase: {}, description: '+2 defending roll; basic units inside use d8 for defense', unlocks: {}, image: 'https://media.base44.com/images/public/69b732e420481df67e8a6804/75b79fd83_23.png' },
  ...
  grand_market: { id: 'grand_market', name: 'Grand Market', emoji: '🏪', starting: false, cost: { gold: 2, wood: 2 }, maxLevel: 3, upgradeBase: { gold: 3 }, description: 'L1: trade with bordering nations · L2: global trade · L3: trade with Silver Union', unlocks: { 1: 'trade_unlock', 2: 'global_trade', 3: 'silver_union_trade' }, image: 'https://media.base44.com/images/public/69b732e420481df67e8a6804/d1ae5b9da_21.png' },
  crimson_port: { id: 'crimson_port', name: 'Crimson Port', emoji: '⚓', starting: false, cost: { gold: 3, wood: 2 }, maxLevel: 1, upgradeBase: {}, description: 'Allow ship building; +1 Gold per port you control', unlocks: { 1: 'shipyard_unlock' }, image: 'https://media.base44.com/images/public/69b732e420481df67e8a6804/36da616cb_22.png' },
...
export const UNIT_DEFS = {
  ...
  // Infamous Reapership (Naval): gold 2 + wood 3 - WATER ONLY, recruitable from crimson_port only
  infamous_reapership: { id: 'infamous_reapership', name: 'Infamous Reapership', emoji: '⛵', dice: 12, cost: { gold: 2, wood: 3 }, canCapture: false, requires: 'crimson_port', requiredBuildingLevel: 1, movementRange: 3, waterOnly: true, type: 'naval', description: 'Naval flagship — WATER ONLY. Recruitable from Crimson Port only. Transports up to 4 units. Naval bombardment: +1 attack to adjacent units. Can blockade enemy ports. 3 hexes/turn.', image: 'https://media.base44.com/images/public/69b732e420481df67e8a6804/4c3f57a91_16.png' },
};
...
export const ACTION_CARDS = [
  ...
  { id: 'peace_treaty', name: 'Peace Treaty', category: 'Diplomacy', cost: { gold: 2, ip: 1 }, heroStat: 'charisma', effect: 'Two players cannot attack each other for 3 turns. Both gain +1 Gold per turn while the treaty lasts. You gain 1 IP', emoji: '🕊️', image: 'https://media.base44.com/images/public/69b732e420481df67e8a6804/e0bea1895_1.png' },
  ...
  { id: 'trade_diplomacy', name: 'Trade Diplomacy', category: 'Trade', cost: { gold: 2, ip: 1 }, heroStat: 'charisma', effect: 'Allows two players to exchange resources freely for 3 turns. Each trade generates +1 extra resource. You gain 1 IP', emoji: '🤝', image: 'https://media.base44.com/images/public/69b732e420481df67e8a6804/60c5cb09a_3.png' },
  { id: 'merchant_fleet', name: 'Merchant Fleet', category: 'Trade', cost: { gold: 2, ip: 1 }, heroStat: 'charisma', effect: 'Trade with any player, even without a Market or port for 2 turns', emoji: '🚢', image: 'https://media.base44.com/images/public/69b732e420481df67e8a6804/caf5c9815_4.png' },
  { id: 'exclusive_contract', name: 'Exclusive Contract', category: 'Diplomacy', cost: { gold: 2, ip: 1 }, heroStat: 'charisma', effect: 'Your trade partner cannot trade with other players for 3 turns', emoji: '📜', image: 'https://media.base44.com/images/public/69b732e420481df67e8a6804/4bbd25f55_5.png' },
  { id: 'tariff_deal', name: 'Tariff Deal', category: 'Trade', cost: { gold: 2, ip: 1 }, heroStat: 'charisma', effect: 'Every time you trade, you gain +1 extra Gold as a tariff bonus for the next 3 turns', emoji: '⚓', image: 'https://media.base44.com/images/public/69b732e420481df67e8a6804/8f4f35690_6.png' },

  { id: 'wheat_monopoly', name: 'Wheat Monopoly', category: 'Trade', cost: { gold: 2, ip: 1 }, heroStat: 'charisma', effect: 'Gain control of one resource type (wheat) for 3 turns; other players must pay +1 Gold to you to trade it', emoji: '🌾', image: 'https://media.base44.com/images/public/69b732e420481df67e8a6804/7fc6c94f3_8.png' },
  { id: 'trade_corridor', name: 'Trade Corridor', category: 'Trade', cost: { gold: 2, ip: 1 }, heroStat: 'charisma', effect: 'All trades generate +1 extra resource for both players for 2 turns', emoji: '🏛️', image: 'https://media.base44.com/images/public/69b732e420481df67e8a6804/8ee3ee6dd_9.png' },
  { id: 'merchant_guild', name: 'Merchant Guild', category: 'Trade', cost: { gold: 2, ip: 1 }, heroStat: 'charisma', effect: 'Once per turn, you may trade directly with the Bank at a 1-for-1 rate', emoji: '🏪', image: 'https://media.base44.com/images/public/69b732e420481df67e8a6804/d24c16455_10.png' },
  { id: 'economic_boom', name: 'Economic Boom', category: 'Trade', cost: { gold: 2, ip: 1 }, heroStat: 'charisma', effect: 'Your Market produces +2 Gold for 3 turns', emoji: '💰', image: 'https://media.base44.com/images/public/69b732e420481df67e8a6804/30a7e537d_11.png' },
  { id: 'war_profiteering', name: 'War Profiteering', category: 'Trade', cost: { gold: 2, ip: 1 }, heroStat: 'charisma', effect: 'Gain +2 Gold per turn if any player is at war', emoji: '⚔️', image: 'https://media.base44.com/images/public/69b732e420481df67e8a6804/cbcdfea0b_12.png' },
  ...
  { id: 'tariff_war', name: 'Tariff War', category: 'Trade', cost: { gold: 2, ip: 1 }, heroStat: 'charisma', effect: 'Force all players to pay 2 extra Gold when buying resources next turn', emoji: '⚓', image: 'https://media.base44.com/images/public/69b732e420481df67e8a6804/8ddbfccb0_14.png' },
