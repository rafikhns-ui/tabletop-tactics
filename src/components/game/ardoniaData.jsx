...
export const LEADERS = {
  ...
  onishiman: [
    { id: 'onseiko_warhound', name: 'Onseiko, The Warhound', type: 'Warlord', cost: { gold: 2 }, faction: 'onishiman',
    ...
    { id: 'chrysanthemum_advisor', name: 'Black Chrysanthemum, Cunning Advisor', type: 'Strategist', cost: { gold: 2, ip: 1 }, faction: 'onishiman',
    ...
    { id: 'tarawa_master', name: 'Ube Tarawa, Underworld Master', type: 'Diplomat', cost: { gold: 2 }, faction: 'onishiman',
      stealth: 3, charisma: 4, force: 1, arcana: 2,
      ability: 'An Offer They Can\'t Refuse: Once per round when initiating diplomatic deal/trade, force other player to choose accept or pay 3 IP. Shadow Patronage: Once per round, if play Clandestine card, gain 1 IP (2 if targets player in diplomatic/trade contact with gain +1 Gold).',
    ...
    { id: 'itawan_shadow_death', name: 'Itawan, The Shadow Death', type: 'Shadow Master', cost: { gold: 3, ip: 1 }, faction: 'onishiman',
    ...
    { id: 'ayame_crimson_spark', name: 'Ayame, The Crimson Spark', type: 'Mage', cost: { gold: 2, sp: 2 }, faction: 'onishiman',
