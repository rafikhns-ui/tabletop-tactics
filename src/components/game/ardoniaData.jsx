...
export const FACTIONS = {
  ...
  gojeon: {
    id: 'gojeon', name: 'Gojeon', color: '#7b5ea7', emoji: '🌸', playable: true,
    continent: 'Mangian',
  ...
  onishiman: {
    id: 'onishiman', name: 'Onishiman', color: '#8b1a1a', emoji: '🐉', playable: true,
    continent: 'Mangian',
  ...
  tlalocayotlan: {
    id: 'tlalocayotlan', name: 'Tlalocayotlan', color: '#c0392b', emoji: '🦎', playable: true,
    continent: 'Mangian',
  ...
  kintei: {
    id: 'kintei', name: 'Kintei', color: '#d35400', emoji: '🐲', playable: true,
    continent: 'Mangian',
  ...
  inuvak: {
    id: 'inuvak', name: 'Inuvak', color: '#5dade2', emoji: '❄️', playable: true,
    continent: 'Mangian',
  ...
  nimrudan: {
    id: 'nimrudan', name: 'Nimrudan', color: '#e67e22', emoji: '🔥', playable: true,
    continent: 'Sharqian',
  ...
  republic: {
    id: 'republic', name: 'Hestia', color: '#1a7a5a', emoji: '⚓', playable: true,
    continent: 'Sharqian',
  ...
  kadjimaran: {
    id: 'kadjimaran', name: 'Kadjimaran', color: '#8b6a1a', emoji: '☀️', playable: true,
    continent: 'Sharqian',
  ...
  oakhaven: {
    id: 'oakhaven', name: 'Oakhaven', color: '#27ae60', emoji: '🌳', playable: true,
    continent: 'Sharqian',
  ...
  ruskel: {
    id: 'ruskel', name: 'Ruskel', color: '#7f8c8d', emoji: '⚙️', playable: true,
    continent: 'Sharqian',
  ...
  sultanate: {
    id: 'sultanate', name: 'Sultanate', color: '#1a5a8b', emoji: '🌙', playable: true,
    continent: 'Sharqian',
  ...
  icebound: {
    id: 'icebound', name: 'Icebound', color: '#aed6f1', emoji: '🌨️', playable: true,
    continent: 'Sharqian',
...
export const BUILDING_DEFS = {
  ...
  temple: { id: 'temple', name: 'Temple', emoji: '⛩️', starting: false, cost: { gold: 6, wood: 4 }, maxLevel: 3, upgradeBase: { gold: 3, wood: 3 }, effect: 'sp', effectPerLevel: { 1: 1, 2: 1, 3: 1 }, description: 'Spiritual power generation', unlocks: { 1: 'basic_ritual', 2: 'advanced_ritual', 3: 'legendary_ritual' }, image: 'https://media.base44.com/images/public/69b732e420481df67e8a6804/fa337750f_30.png' },
  barracks: { id: 'barracks', name: 'Barracks', emoji: '🎖️', starting: false, cost: { gold: 6, wood: 4 }, maxLevel: 3, upgradeBase: { gold: 3, wood: 2 }, description: 'Unit recruitment and training', unlocks: { 1: 'infantry_recruit', 2: 'elite_recruit', 3: 'hero_recruit' }, image: 'https://media.base44.com/images/public/69b732e420481df67e8a6804/fa337750f_30.png' },
  market: { id: 'market', name: 'Market', emoji: '🏪', starting: false, cost: { gold: 6, wood: 4 }, maxLevel: 3, upgradeBase: { gold: 3, wood: 2 }, effect: 'gold', effectPerLevel: { 1: 1, 2: 1, 3: 2 }, description: 'Trade and commerce hub', unlocks: { 1: 'local_trade', 2: 'regional_trade', 3: 'global_trade' }, image: 'https://media.base44.com/images/public/69b732e420481df67e8a6804/fa337750f_30.png' },
  stables: { id: 'stables', name: 'Stables', emoji: '🐴', starting: false, cost: { gold: 5, wood: 4 }, maxLevel: 2, upgradeBase: { gold: 3, wood: 3 }, description: 'Cavalry unit production', unlocks: { 1: 'cavalry_recruit', 2: 'elite_cavalry' }, image: 'https://media.base44.com/images/public/69b732e420481df67e8a6804/fa337750f_30.png' },
  archerytower: { id: 'archerytower', name: 'Archery Tower', emoji: '🏹', starting: false, cost: { gold: 5, wood: 4 }, maxLevel: 2, upgradeBase: { gold: 3, wood: 3 }, description: 'Ranged unit production', unlocks: { 1: 'archer_recruit', 2: 'elite_archer' }, image: 'https://media.base44.com/images/public/69b732e420481df67e8a6804/fa337750f_30.png' },
...
export const AVATARS = {
  onishiman: [
    ...
    { id: 'eternal_emperor', name: 'The Eternal Emperor', tier: 'Legendary', cost: { ip: 4 }, templeLevel: 3, duration: 3, passive: 'At start of turn, gain +2 IP', active: 'Kneel Before Me: Spend 5 IP to seize full control of an entire region (all territories within it). Enemy units in that region must immediately retreat to the nearest adjacent region or be destroyed.', emoji: '👹', image: 'https://media.base44.com/images/public/69b732e420481df67e8a6804/ca56fd4c2_18.png' },
    { id: 'guardian_eternal', name: 'Guardian of the Eternal Emperor', tier: 'Avatar-Construct', cost: { militaryUnit: 1 }, templeLevel: 3, duration: 3, passive: 'Eternal Vigil: All friendly units in the same region roll +1 when defending', active: 'Soul Surge (use once per summon): Spend 2 SP to grant all units in the same battle +2 to their rolls for one round', emoji: '🔱', image: 'https://media.base44.com/images/public/69b732e420481df67e8a6804/ac7245089_19.png' },
    { id: 'elder_protectors', name: 'Elder Protectors', tier: 'Greater', cost: { sp: 2 }, templeLevel: 2, duration: 3, passive: 'Waters of Silence: Enemy units entering your region roll -1 on their first attack, as if the spirit drowns their will to fight', active: 'Tidal Awakening: Spend 3 SP to unleash a wave of spectral energy. Make your enemy reroll on dice for any action and take the lowest result once per round', emoji: '🌊', image: 'https://media.base44.com/images/public/69b732e420481df67e8a6804/6ec299a80_20.png' },
  ],
  sultanate: [
