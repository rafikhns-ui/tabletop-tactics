...
export const LEADERS = {
  ...
  onishiman: [
    { id: 'onseiko_warlord', name: 'Onseiko, The Warlord', passive: '+2 attack in siege warfare, can negate fortification bonuses', disadvantage: 'Cannot use diplomacy cards', type: 'Military' },
    { id: 'chrysanthemum_advisor', name: 'Black Chrysanthemum, Advisor', passive: '+1 IP per turn from intrigue', disadvantage: 'Cannot declare war without paying 3 extra IP', type: 'Political' },
    { id: 'tarawa_underworld', name: 'Ube Tarawa, Underworld Master', passive: '+1 IP per turn from shadow dealings', disadvantage: 'Cannot sign open alliances', type: 'Diplomatic' },
  ],
  tlalocayotlan: [
...
export const HEROES = {
  ...
  onseiko_warhound: {
    ...
    stealth: 2, charisma: 2, force: 5, arcana: 1,
    cost: { gold: 2 }, faction: 'onishiman', requiredBuilding: 'barracks',
    ability: 'Siege Killer: Once per turn, targeted unit may ignore Fort/Tower bonuses. Warhound Unleashed: Once per game, become a unit rolling D10 in combat.',
    passive: '+2 attack in siege warfare, can negate fortification bonuses',
    passiveEffect: { attackBonus: 2 },
    image: 'https://media.base44.com/images/public/69b732e420481df67e8a6804/f49c1c3ec_5.png',
  },
  chrysanthemum_cunning: {
    id: 'chrysanthemum_cunning', name: 'Black Chrysanthemum, Cunning Advisor', type: 'Strategist',
    stealth: 3, charisma: 3, force: 1, arcana: 3,
    cost: { gold: 2, ip: 1 }, faction: 'onishiman', requiredBuilding: 'barracks',
    ability: 'Web of Shadows: Once per round, reduce cost of one Clandestine card by 2 IP. False Alliances: Once per game round, choose a player - they cannot play Trade/Diplomacy cards unless they pay 2 extra IP.',
    passive: '+1 IP per turn from intrigue',
    passiveEffect: { ipPerTurn: 1 },
  ...
  ube_tarawa: {
    ...
    stealth: 3, charisma: 4, force: 1, arcana: 2,
    cost: { gold: 2 }, faction: 'onishiman', requiredBuilding: 'market',
    ability: 'An Offer They Can\'t Refuse: Once per round when initiating diplomatic deal/trade, force other player to choose accept or pay 3 IP. Shadow Patronage: Once per round, if play Clandestine card, gain 1 IP.',
    passive: '+1 IP per turn from shadow patronage',
    passiveEffect: { ipPerTurn: 1 },
    image: 'https://media.base44.com/images/public/69b732e420481df67e8a6804/64120de3b_7.png',
  },
  itawan_shadow: {
    id: 'itawan_shadow', name: 'Itawan, The Shadow Death', type: 'Shadow Master',
    stealth: 5, charisma: 2, force: 2, arcana: 3,
    cost: { gold: 3, ip: 1 }, faction: 'onishiman', requiredBuilding: 'barracks',
    ability: 'Silent Kill: Once per round, spend 2 IP to eliminate one enemy non-hero unit (roll D6 on elite units, 5+ to eliminate). Smokescreen: Once per game round, spend 1 IP to cancel any single combat roll.',
    passive: '+2 stealth bonuses in diplomacy/clandestine actions',
    passiveEffect: { defenseBonus: 1 },
    image: 'https://media.base44.com/images/public/69b732e420481df67e8a6804/6d20b07ec_8.png',
  },
  ayame_crimson: {
    id: 'ayame_crimson', name: 'Ayame, The Crimson Spark', type: 'Mage',
    stealth: 2, charisma: 2, force: 1, arcana: 5,
    cost: { gold: 2, sp: 2 }, faction: 'onishiman', requiredBuilding: 'temple',
    ability: 'Crimson Lightning: Once per turn target territory within 2 you control, roll D12 - on 7+, destroy up to 3 enemy units (gain +1 SP if 3+ destroyed). Flashblind: Roll D6 - on 3+ to prevent enemy army from moving into chosen territory for one turn (gain 1 IP).',
    passive: '+1 SP per turn from arcane power',
    passiveEffect: { spPerTurn: 1 },
