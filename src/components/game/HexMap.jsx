              ...
              <div>
                {hoveredStructure === 'port' && (
                  <div style={{ position: 'fixed', top: '50%', left: '50%', transform: 'translate(-50%,-50%)', zIndex: 9999, pointerEvents: 'none' }}>
                    <img src="https://media.base44.com/images/public/69b732e420481df67e8a6804/36da616cb_22.png" alt="Port" style={{ width: 220, borderRadius: 12, border: '3px solid #4488ff', boxShadow: '0 0 60px #4488ff66' }} />
                  </div>
                )}
