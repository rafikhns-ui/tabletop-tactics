...
function OpenOffersPanel({ gameState, playerFactionId, onStateChange }) {
  ...
  return /* @__PURE__ */ jsxs("div", { style: { marginBottom: 18 }, children: [
    ...
    /* @__PURE__ */ jsx("div", { style: { display: "flex", flexDirection: "column", gap: 6 }, children: offers.map((o) => /* @__PURE__ */ jsx(
      OfferRow,
      {
        offer: o,
        gameState,
...
function OfferRow({ offer, gameState, onAccept, onReject }) {
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { style: { fontSize: 10, letterSpacing: 1.5, opacity: 0.6 }, children: [
          offer.type.replace(/_/g, " "),
          " \xB7 from ",
          fromLabel,
          turnsLeft > 0 ? ` \xB7 ${turnsLeft} turn(s) left` : " \xB7 expires this turn"
        ] }),
        /* @__PURE__ */ jsx("div", { style: { marginTop: 4 }, children: describeOffer(offer) }),
        /* @__PURE__ */ jsxs("div", { style: { display: "flex", gap: 6, marginTop: 8 }, children: [
          /* @__PURE__ */ jsx("button", { onClick: onAccept, style: buttonStyle("accept"), children: "Accept" }),
          /* @__PURE__ */ jsx("button", { onClick: onReject, style: buttonStyle("reject"), children: "Refuse" })
        ] })
      ]
    }
  );
